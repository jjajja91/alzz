...
<div id="content-wrapper" class="d-flex flex-column">
	...
	<div id="content">
					...
					<div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
						...
						<a class="dropdown-item d-flex align-items-center" href="#">
							...
							<div>
								...
								<span class="font-weight-bold">A new monthly report isready to download!</span>
							</div>
						</a> 
						<a class="dropdown-item d-flex align-items-center" href="#">
							<div class="mr-3">
				...
				<li class="nav-item dropdown no-arrow">
					...
					<div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
						<a class="dropdown-item" href="#"> 
							<iclass="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i> Profile
						</a> 
						<a class="dropdown-item" href="#"> 
		...
		<div class="container-fluid">
			...
			<p class="mb-4">심사 요청 클래스</p>

			<div class="lesson-container">
			
				<div class="lesson-main">
					<input type="hidden" id="lessonId" value='<c:out value="${lesson.id }"/>' />
...
<script type="text/javascript">
	...
	function changeLessonStateApi(data){
		return $.ajax({
			...
			success : self.location = "/admin/lesson/lessonReqList"
		});
	}
</script>
</body>
